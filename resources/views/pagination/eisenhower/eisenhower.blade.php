...
<div class="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-6">
	<div class="card bg-red-200">
		<div class="p-5">
			<div class="flex justify-between">
				<div class="w-20 h-20 rounded-full inline-flex items-center justify-center bg-red-100 "title="Geçiken veya anlık gelen işler." tabindex="0" data-plugin="tippy" data-tippy-followcursor="true" data-tippy-arrow="true" data-tippy-animation="fade">
                    <i class="mgc_information_line text-4xl text-red-500"></i>
				</div>
				<div class="text-right">

                <h3 class="text-red-600 mt-1 text-2xl font-bold mb-5 dark:red-gray-300">3947</h3>
	...
	<div class="card bg-orange-200">
		<div class="p-5">
			<div class="flex justify-between">
				<div class="w-20 h-20 rounded-full inline-flex items-center justify-center bg-orange-100" title="Sürekli devamlılığı olan kısım kısım yapılan işler." tabindex="0" data-plugin="tippy" data-tippy-followcursor="true" data-tippy-arrow="true" data-tippy-animation="fade">
					<i class="mgc_information_line text-4xl text-orange-500" ></i>
				</div>
				<div class="text-right">
					<h3 class="text-orange-600 mt-1 text-2xl font-bold mb-5 dark:text-gray-300">624</h3>
	...
	<div class="card bg-yellow-200">
		<div class="p-5">
			<div class="flex justify-between">
				<div class="w-20 h-20 rounded-full inline-flex items-center justify-center bg-yellow-100" title="Şirket içerisinden veya dışarıdan alınan hizmetler" tabindex="0" data-plugin="tippy" data-tippy-followcursor="true" data-tippy-arrow="true" data-tippy-animation="fade">
					<i class="mgc_information_line text-4xl text-yellow-500"></i>
				</div>
				<div class="text-right">
					<h3 class="text-yellow-600 mt-1 text-2xl font-bold mb-5 dark:text-gray-300">3195</h3>
	...
	<div class="card bg-green-200">
		<div class="p-5">
			<div class="flex justify-between">
				<div class="w-20 h-20 rounded-full inline-flex items-center justify-center bg-green-100" title="İleri tarihli işler." tabindex="0" data-plugin="tippy" data-tippy-followcursor="true" data-tippy-arrow="true" data-tippy-animation="fade">
					<i class="mgc_information_line text-4xl text-green-500"></i>
				</div>
				<div class="text-right">
					<h3 class="text-green-600 mt-1 text-2xl font-bold mb-5 dark:text-gray-300">128</h3>
...
<div class="mt-6">
	<div class="card">
		<div class="flex flex-wrap justify-between items-center gap-2 p-6">
			<a href="javascript:void(0);" class="btn bg-info/25 text-sm font-medium text-info hover:text-white hover:bg-info">
				<i class="mgc_add_circle_line me-3"></i>
				Görev Ekle</a>
			<div class="flex flex-wrap gap-2">

				<button type="button" class="btn bg-dark/25 text-sm font-medium text-slate-900 dark:text-slate-200/70 hover:text-white hover:bg-dark/90">Dışarı Aktar</button>
			</div>
		</div>
